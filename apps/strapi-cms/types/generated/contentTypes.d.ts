...
export interface ApiManufacturerManufacturer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<"api::manufacturer.manufacturer", "title"> &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiModelModel extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    slug: Attribute.UID<"api::model.model", "title">;
    seo: Attribute.Component<"shared.seo">;
    modelKit: Attribute.Relation<
      "api::model.model",
      "oneToOne",
    ...
    buildLog: Attribute.Component<"models.build", true>;
    reviewPost: Attribute.Relation<
      "api::model.model",
      "oneToOne",
      "api::post.post"
    >;
...
export interface ApiModelKitModelKit extends Schema.CollectionType {
  ...
  attributes: {
    ...
    manufacturer: Attribute.Relation<
      ...
      "api::manufacturer.manufacturer"
    >;
    scale: Attribute.Relation<
      "api::model-kit.model-kit",
      "oneToOne",
      "api::scale.scale"
    >;
    kitNumber: Attribute.String & Attribute.Required;
    scalematesLink: Attribute.String;
    yearReleased: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      "api::model-kit.model-kit",
...
export interface ApiModelTagModelTag extends Schema.CollectionType {
  collectionName: "model_tags";
  info: {
    singularName: "model-tag";
    pluralName: "model-tags";
  ...
  attributes: {
    ...
    slug: Attribute.UID<"api::model-tag.model-tag", "tag"> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      "api::model-tag.model-tag",
...
export interface ApiScaleScale extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    slug: Attribute.UID<"api::scale.scale", "title"> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      "api::scale.scale",
