...
import { GalleryUncheckedUpdateManyWithoutImagesNestedInput } from '../gallery/gallery-unchecked-update-many-without-images-nested.input';

@InputType()
export class GalleryImageUncheckedUpdateInput {
    ...
    @Field(() => GalleryUncheckedUpdateManyWithoutImagesNestedInput, {nullable:true})
    galleries?: GalleryUncheckedUpdateManyWithoutImagesNestedInput;
}
