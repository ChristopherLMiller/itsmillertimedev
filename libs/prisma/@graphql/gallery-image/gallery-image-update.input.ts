...
import { GalleryUpdateManyWithoutImagesNestedInput } from '../gallery/gallery-update-many-without-images-nested.input';
...
export class GalleryImageUpdateInput {
    ...
    @Field(() => GalleryUpdateManyWithoutImagesNestedInput, {nullable:true})
    galleries?: GalleryUpdateManyWithoutImagesNestedInput;
}
