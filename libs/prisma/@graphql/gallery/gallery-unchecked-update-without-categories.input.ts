...
import { GalleryTagUncheckedUpdateManyWithoutGalleryNestedInput } from '../gallery-tag/gallery-tag-unchecked-update-many-without-gallery-nested.input';
...
@InputType()
export class GalleryUncheckedUpdateWithoutCategoriesInput {
    ...
    @Field(() => GalleryTagUncheckedUpdateManyWithoutGalleryNestedInput, {nullable:true})
