...
import { MinecraftRuleCategoryWhereInput } from '../minecraft-rule-category/minecraft-rule-category-where.input';
...
import { MinecraftRuleCategoryWhereUniqueInput } from '../minecraft-rule-category/minecraft-rule-category-where-unique.input';
import { Int } from '@nestjs/graphql';
import { MinecraftRuleCategoryCountAggregateInput } from '../minecraft-rule-category/minecraft-rule-category-count-aggregate.input';
import { MinecraftRuleCategoryAvgAggregateInput } from '../minecraft-rule-category/minecraft-rule-category-avg-aggregate.input';
import { MinecraftRuleCategorySumAggregateInput } from '../minecraft-rule-category/minecraft-rule-category-sum-aggregate.input';
import { MinecraftRuleCategoryMinAggregateInput } from '../minecraft-rule-category/minecraft-rule-category-min-aggregate.input';
import { MinecraftRuleCategoryMaxAggregateInput } from '../minecraft-rule-category/minecraft-rule-category-max-aggregate.input';
