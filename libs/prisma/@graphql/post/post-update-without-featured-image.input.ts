...
import { PostCategoryUpdateOneRequiredWithoutPostsNestedInput } from '../post-category/post-category-update-one-required-without-posts-nested.input';
import { PostTagUpdateManyWithoutPostsNestedInput } from '../post-tag/post-tag-update-many-without-posts-nested.input';

@InputType()
export class PostUpdateWithoutFeaturedImageInput {
    ...
    @Field(() => PostCategoryUpdateOneRequiredWithoutPostsNestedInput, {nullable:true})
